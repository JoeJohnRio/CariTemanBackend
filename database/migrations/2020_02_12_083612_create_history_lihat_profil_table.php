...
class CreateHistoryLihatProfilTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_lihat_profil', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('history_lihat_profil');
    }
}
